...
BY:	Aravind Dhulipalla
		...
		UMASS Lowell
PURPOSE
Contains the main initialization of the OS and UART and starts executing the tasks.
...
static  CPU_VOID  Init (CPU_VOID *data)
{
  ...
  InitMemMgr();
  CreateRobotManagerTask(); //Creates Payload Task
  CreateParserTask();  //Creates Parser Task
  CreateFramerTask(); //Creates Framer Task
